...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		playerUrl: "https://webdatabese.pages.dev/file/1787912955417_video_kipfel可爱！_mizi_m..._0.mp4",
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
		...
		homeText: {
			...
			subtitle: [
				...
				"Wishing you a schoolday every day",
				"A new day,goodmood",
				"Good mornig,googafternoon,googafternoon,goodevening",
				"Don't be overlyfixatad on one person",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
			...
			links: [
				{
					...
					url: "https://github.com/windowsniqiu",
					showName: true,
				},
				{
					name: "Email",
					icon: "fa7-solid:envelope",
					url: "hellogoldenloach@outlook.com",
				},
				{
					name: "RSS",
					icon: "fa7-solid:rss",
